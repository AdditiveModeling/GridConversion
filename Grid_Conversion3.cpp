...
int main()
{
	std::string input_filepath = "/lore/pessij/result_Grid_Test2/";
	std::string input_filename = "500x500x500m";
	std::string output_filename = "500x500x500_grid3.csv";
	
	double grid_origin[] = {180,210,1};
	int num_parts = 4;
	int grid_dir[] = {1,1,1};
	int num_pts[] = {1,1740,1087};
