...
g++ -c Grid_Conversion2.cpp -o Grid_Conversion2.o

g++ read_results_file.o node_location_tests.o FEM_solution_manipulation.o Grid_Conversion2.o -o Grid_Conversion2
